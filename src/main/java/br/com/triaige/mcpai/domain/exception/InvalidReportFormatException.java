...
/**
 * Spec Fase 3, seção 6: relatório do modelo fora do schema esperado mesmo após 1 retry de
 * geração — falha de formatação, não repassada como está. A spec não lista um HTTP code
 * próprio para esse caso fora dos 4 da seção 4.4; tratado como 502, mesma família de
